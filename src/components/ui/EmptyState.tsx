  ...
  return (
    ...
    >
      ...
      <motion.h3 
        ...
        className={`text-lg sm:text-xl font-bold mb-2 ${isLight ? "text-black" : "text-white"}`}
      >
        {title}
      </motion.h3>
      <motion.p 
        ...
        className={`${isLight ? "text-gray-600" : "text-gray-400"} text-sm sm:text-base max-w-md mb-6 sm:mb-8`}
      >
        {description}
      </motion.p>
      ...
      {action && (
        <motion.button
          ...
          className={`px-4 sm:px-5 md:px-6 py-2 sm:py-2.5 ${isLight 
